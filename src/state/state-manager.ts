...
export class StateManager {
    ...
    getContentState(contentId: string): BaseContent | null {
        return this.get<BaseContent>(`content:${contentId}`);
    }

    setContentState(contentId: string, content: BaseContent): void {
