...
export class AIEnhancementProcessor {
  ...
  private async addSummary(content: StructuredContent): Promise<void> {
  ...
  private async addKeywords(content: StructuredContent): Promise<void> {
  ...
  private async expandContent(content: StructuredContent): Promise<void> {
  ...
  private async improveReadability(content: StructuredContent): Promise<void> {
    const parser = StructuredOutputParser.fromZodSchema(
      z.object({
        score: z.number(),
